    ...
    <div class="container">
        <div class="row">
            <div class="col-lg m-b30">
                <h2 class="title-head ">Guru<br /></h2>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Para Guru Yang Mengajar</h3>
                            ...
                            <div class="card-body table-responsive p-0" style="height: 300px;">
                                <table class="table table-head-fixed table-hover break-all full-width table-striped ">
                                    <thead style="position: -webkit-sticky; /* Safari */ position: sticky; top: 0%; background:grey">
                                        <tr>
                                            <th>NIP</th>
                                            <th>Nama</th>
                                            <th>Mengajar</th>
